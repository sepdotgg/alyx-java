...
public abstract class AbstractAlyxCommandListener extends AbstractAlyxListenerAdapter {
    ...
    public final void onMessageReceived(final MessageReceivedEvent event) {
        ...
        if (rawMessage.startsWith(alyx.getCommandPrefix())) {
            ...
            final List<AlyxCommand> matchingCommands = this.alyx.getLoadedCommands().stream().filter(command -> command.matches(cmd)).collect(Collectors.toList());
    ...
    @lombok.Generated
    public AbstractAlyxCommandListener(final Alyx alyx) {
        this.alyx = alyx;
    }
}
